                    ...
                    {plans.map((plan) => (
                        ...
                        >
                            ...
                            <div className="flex items-baseline gap-2 mb-2">
                                <span className={`text-3xl sm:text-4xl font-extrabold ${plan.price === 'FREE' ? 'text-quantix-light' : 'text-transparent bg-clip-text bg-gradient-to-br from-white to-quantix-light'}`}>
                                    {plan.price}
                                </span>
                            </div>
